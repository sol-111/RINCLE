...
- DB再構築が進行中（あと約2週間）→ 完了後に検索速度改善とまとめて本番リリース、SEO設定一式+GA4/Clarity設置（#21-22）
- 決済基盤の方針を次回定例で報告（#20・#25調査完了。結論: 短期はPay.jp続行、全体設計後にStripe載せ替え — 詳細はpayjp-vs-stripe-comparison.md）
- KGI/KPI目標は凍結中（実績が積み上がってから設定。紙請求突合#29は中止 — 2026-06-12瀬野さん判断）
