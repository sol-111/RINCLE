...
| 日付 | 静的 | 店舗 | 自転車 | 合計 | 備考 |
|---|---|---|---|---|---|
| 2026-08-21 | 3 | 63 | 342 | **408 URL** | 本番Data APIから初回生成。店舗は全67件中、審査未通過3・辞退1を除外（在庫ゼロの10店は掲載）。自転車は全440件中、非表示89・削除6・掲載しない店舗の9台を除外 |

※ 本番サイトの検索に出る店舗は53件（在庫のある店舗のみ表示されるため）。sitemapの63件との差10件は「レンタル車体準備中」等の在庫ゼロ店舗で、意図して載せている。
